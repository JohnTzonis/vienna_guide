      ...
      <div>
        ...
        <div className='flex flex-col gap-y-2 mt-2 pb-4 border-b border-gray-100'>
          ...
          <ul className='flex flex-col justify-start gap-y-2'>
            ...
            <li className='flex items-center gap-x-2 px-2 pt-1 pb-1.5 rounded bg-gray-700'>
              <span className='text-2xl grow hover:text-blue-400'><a href="https://www.onb.ac.at/en/" target="_blank">Austrian National Library</a></span>
              {/* <span className='mt-1 italic'>( Hints: Gustav Klimt )</span> */}
        ...
        <div className='flex flex-col gap-y-2 mt-2 pb-4 border-b border-gray-100'>
          ...
          <ul className='flex flex-col justify-start gap-y-2'>
            {/* Bar Pigalle */}
            <li className='flex items-center gap-x-2 px-2 pt-1 pb-1.5 rounded bg-gray-700'>
              <span className='text-2xl grow hover:text-blue-400'><a href="https://pigalle-wien.com/" target="_blank">Bar Pigalle</a></span>
              {/* <span className='mt-1 italic'>(  )</span> */}
        ...
        <div className='flex flex-col gap-y-2 mt-2 pb-4 border-b border-gray-100'>
          ...
          <ul className='flex flex-col justify-start gap-y-2'>
            ...
            {/* Skopik & Lohn */}
            <li className='flex items-center gap-x-2 px-2 pt-1 pb-1.5 rounded bg-gray-700'>
              <span className='text-2xl grow hover:text-blue-400'><a href="https://skopikundlohn.at/en/home-english/" target="_blank">Skopik & Lohn</a></span>
              {/* <span className='mt-1 italic'>(  )</span> */}
            ...
            {/* Schnitzelwirt */}
            <li className='flex items-center gap-x-2 px-2 pt-1 pb-1.5 rounded bg-gray-700'>
              <span className='text-2xl grow hover:text-blue-400'><a href="https://www.schnitzelwirt.co.at/" target="_blank">Schnitzelwirt</a></span>
              {/* <span className='mt-1 italic'>(  )</span> */}
        ...
        <div className='flex flex-col gap-y-2 mt-2 pb-4 border-b border-gray-100'>
          ...
          <ul className='flex flex-col justify-start gap-y-2'>
            {/* Comics Hutterer */}
            <li className='flex items-center gap-x-2 px-2 pt-1 pb-1.5 rounded bg-gray-700'>
              <span className='text-2xl grow hover:text-blue-400'><a href="http://www.comicshutterer.at/" target="_blank">Comics Hutterer</a></span>
              {/* <span className='mt-1 italic'>(  )</span> */}
